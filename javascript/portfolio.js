...
const portfolioData = [
    {
        ...
        desc: 'เป็นการแข่งขันที่เกี่ยวกับการออกแบบสิ่งของเครื่องใช้ในปีการศึกษา 2567 โดยหัวข้อที่ได้รับในการแข่ขันคือ Food trusk (รถขายอาหาร) โดยมีวัตถุประสงค์เพื่อให้นักเรียนได้ฝึกทักษะการออกแบบและสร้างสรรค์สิ่งของเครื่องใช้ที่สามารถนำไปใช้ในชีวิตประจำวันได้',
        image: '../assets/3015200103-35_page-0001.jpg'
    },
    {
        title: 'ประกาศนียบัตร / ผลงานที่ 2',
        desc: 'เป็นการแข่งขันเกี่ยวกับทักษะคอมพิวเตอร์ในปีการศึกษา 2568 โดยหัวข้อที่ได้รับในการแข่ขันคือ การสร้างเว็บไซต์หัวข้อ "อาหารจีนหรือเจ" โดยใช้โปรแกรม Adobe Dreamweaver CS6 และ Adobe Photoshop CS6 โดยมีวัตถุประสงค์เพื่อให้นักเรียนได้ฝึกทักษะการออกแบบและพัฒนาเว็บไซต์ที่สามารถนำไปใช้ในชีวิตประจำวันได้',
        image: '../assets/web68_cerby_compet_99_school_183-1_page-0001.jpg'
    },
    {
        title: 'ประกาศนียบัตร / ผลงานที่ 3',
        desc: 'เป็นการแข่งขันเกี่ยวกับทักษะคอมพิวเตอร์ในปีการศึกษา 2569 โดยหัวข้อที่ได้รับในการแข่ขันคือ การสร้างเว็บไซต์หัวข้อ "การฟื้นฟูระบบนิเวศและการกักเก็บคาร์บอน" โดยใช้โปรแกรม Adobe Dreamweaver CS6 และ Adobe Photoshop CS6 โดยมีวัตถุประสงค์เพื่อให้นักเรียนได้ฝึกทักษะการออกแบบและพัฒนาเว็บไซต์ที่สามารถนำไปใช้ในชีวิตประจำวันได้',
